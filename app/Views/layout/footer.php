<footer class="text-center lg:text-left bg-gray-100 w-screen text-gray-600">
    <div class="flex justify-center items-center lg:justify-between max-w-4xl mx-5 lg:mx-auto py-6 border-b border-gray-300">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
        <div class="max-w-4xl mx-5 lg:mx-auto flex justify-between lg:flex-row flex-col">
            <div class="w-96">
                <h6 class="
            uppercase
            font-semibold
    ...
    <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-gray-600 font-semibold" href="https://rd-portofolio.vercel.app/">RD-TEAM</a>
    </div>
</footer>